...
<template>
  <LoginLayout>
    <div
      class="w-full max-w-md bg-white/10 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/20 shadow-2xl"
    >
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        <div class="space-y-2">
          <label class="block text-white/70 text-sm font-bold ml-1"
        ...
        <div
          v-if="errorMessage"
          class="p-4 bg-red-500/20 border border-red-500/50 rounded-xl text-red-200 text-sm text-center font-bold"
        >
          {{ errorMessage }}
        </div>
